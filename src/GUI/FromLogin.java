...
public class FromLogin extends javax.swing.JFrame {
    ...
    if("Aris".equals(textUserName.getText())){
        if("Aris".equals(textPassword.getText())){
            JOptionPane.showConfirmDialog(rootPane,"Password anda salah","Password salah", JOptionPane.ERROR_MESSAGE);
            
        }else{
            //code jika user password salah
            FromPenentuJumlahHari fromHari = new FromPenentuJumlahHari();
            fromHari.setVisible(true);
            dispose();
            
        }
    }else{
         JOptionPane.showConfirmDialog(rootPane,"Username anda belum terdaftar","User salah", JOptionPane.ERROR_MESSAGE);
    }
